...
class getMessenger_Bus_Default_Messenger_HandlersLocatorService extends Academy_App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 1), 'Academy\\ActivityItinerary\\Application\\ShowListActivity\\ShowListActivityCommand' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.HSUkrVB'] ?? $container->load('get_Messenger_HandlerDescriptor_HSUkrVBService'));
        }, 1)]);
    }
}
